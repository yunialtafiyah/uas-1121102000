...
// // import UpdateMahasiswa from "fetch/updateMahasiswa";
...
//     return(
//         <main>
//             <h1 className="color=blue">Daftar Mahasiswa</h1>
      ...
      >
        {selectedMahasiswa && (
          <div>
            ...
            <p>Prodi: {selectedMahasiswa.attributes.prodi}</p>
